...
public static class ErrorCodes
{
    ...
    public static readonly ErrorCode NOT_FOUND_USER = new ErrorCode(4040, ErrorMessage.UserNotFound);
    ...
    public static readonly ErrorCode UNIQUE_USER = new ErrorCode(4000, ErrorMessage.UniqueUser);
 
 
    public static readonly ErrorCode JWT_OPERATION_FAILED = new ErrorCode(5000, ErrorMessage.UniqueUser);
